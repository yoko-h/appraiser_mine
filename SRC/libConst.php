...
//工事管理編集完了処理
//
function subConstEditCompleteNull($conn, $value)
{
...
function subConstEditComplete()
{
  ...
  $area           = ($_REQUEST['area'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['area']);
  $years          = mysqli_real_escape_string($conn, $_REQUEST['years']);
  $sellPrice      = ($_REQUEST['sellPrice'] === '') ?  null : mysqli_real_escape_string($conn, $_REQUEST['sellPrice']);
  $interiorPrice  = ($_REQUEST['interiorPrice'] === '') ?  null : mysqli_real_escape_string($conn, $_REQUEST['interiorPrice']);
  $constTrader    = mysqli_real_escape_string($conn, $_REQUEST['constTrader']);
  $constPrice     = ($_REQUEST['constPrice'] === '') ?  null : mysqli_real_escape_string($conn, $_REQUEST['constPrice']);
  $constAdd       = mysqli_real_escape_string($conn, $_REQUEST['constAdd']);
  $constNote      = mysqli_real_escape_string($conn, $_REQUEST['constNote']);
  $purchaseDT     = ($_REQUEST['purchaseDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['purchaseDT']);
  $workStartDT    = ($_REQUEST['workStartDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['workStartDT']);
  $workEndDT      = ($_REQUEST['workEndDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['workEndDT']);
  $lineOpenDT     = ($_REQUEST['lineOpenDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['lineOpenDT']);
  $lineCloseDT    = ($_REQUEST['lineCloseDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['lineCloseDT']);
  ...
  $leavingDT      = ($_REQUEST['leavingDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST['leavingDT']);
  ...
  $constFlg1 = (isset($_REQUEST['constFlg1']) && $_REQUEST['constFlg1'] === '') ? null : (isset($_REQUEST['constFlg1']) ? mysqli_real_escape_string($conn, $_REQUEST['constFlg1']) : null);
  $constFlg2 = (isset($_REQUEST['constFlg2']) && $_REQUEST['constFlg2'] === '') ? null : (isset($_REQUEST['constFlg2']) ? mysqli_real_escape_string($conn, $_REQUEST['constFlg2']) : null);
  $constFlg3 = (isset($_REQUEST['constFlg3']) && $_REQUEST['constFlg3'] === '') ? null : (isset($_REQUEST['constFlg3']) ? mysqli_real_escape_string($conn, $_REQUEST['constFlg3']) : null);
  $constFlg4 = (isset($_REQUEST['constFlg4']) && $_REQUEST['constFlg4'] === '') ? null : (isset($_REQUEST['constFlg4']) ? mysqli_real_escape_string($conn, $_REQUEST['constFlg4']) : null);
  $lineOpenContactDT = ($_REQUEST['lineOpenContactDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST["lineOpenContactDT"]);
  $lineCloseContactDT = ($_REQUEST['lineCloseContactDT'] === '') ? null : mysqli_real_escape_string($conn, $_REQUEST["lineCloseContactDT"]);
  ...
  $lightOrder     = ($_REQUEST['lightOrder'] ?? '') === '' ? null : mysqli_real_escape_string($conn, $_REQUEST["lightOrder"] ?? '');
