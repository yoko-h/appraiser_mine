          ...
          ?>
            ...
            <?php
              ...
              if ($row2 !== null) {
                ...
                $pdfNo = ''; // または適切なデフォルト値
                $note  = '';  // または適切なデフォルト値
                // 必要であれば、ログにエラーを出力するなどの処理を追加
                error_log("Warning: \$row2 is null at line 398 or 399 of libFManager.php (fMNo: " . htmlspecialchars($fMNo) . ", docNo: " . htmlspecialchars($docNo) . ")");
              }
            ?>
              <tr>
